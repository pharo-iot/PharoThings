...
Devices incapsulate pin configuration logic. You don't need configure input pin manually when you create the button instance. Just install device and pin will work. 
